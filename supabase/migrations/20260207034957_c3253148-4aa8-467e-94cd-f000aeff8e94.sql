...
-- Create a function to create provider profile after signup (bypasses RLS)
...
GRANT EXECUTE ON FUNCTION public.create_provider_profile(uuid, text, text, provider_type, text, text, text, text) TO authenticated;
